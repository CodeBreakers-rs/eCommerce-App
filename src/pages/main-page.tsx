        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-8 items-center rounded-3xl bg-[#fbeee2] p-2">
          ...
          <div className="flex-1 text-center lg:text-left space-y-4">
            <h1 className="text-4xl sm:text-5xl font-extrabold leading-snug text-[#2f2b27]">
              Homemade Zefir,
              <br className="hidden sm:inline" /> No Artificial Flavors
            </h1>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-[#2f2b27] text-base space-y-4 max-w-lg mx-auto md:mx-0">
            <p>
              ...
              by car, ensuring quick and reliable service.
            </p>
            <p>
              Enjoy free delivery on orders of $120 or more, or take advantage
              of our special offer: free delivery every Tuesday between 12–2 pm,
        ...
        <div className="mt-10 flex flex-wrap md:flex-nowrap items-start justify-center gap-25 md:justify-start md:px-8">
          <div className="flex flex-col items-center space-y-4 max-w-sm text-center">
            ...
            <div className="text-sm text-[#493220] space-y-5 text-left w-full">
              ...
              <p>
                Order Deadline: Please place your orders at least 2 days before
                the desired pickup or delivery date. This ensures that your
                desserts are prepared fresh and on time.
              </p>
            </div>
          </div>
